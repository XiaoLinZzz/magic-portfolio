---
title: "Staff and Contract Management Platform for Cleaning Services"
publishedAt: "2024-07-08"
summary: "Led the development of a comprehensive cleaning service management platform using React Native for mobile, React.js for web portal. Implemented real-time staff tracking, shift management, and automated reporting features while collaborating with stakeholders through Figma-driven design process."
images:
  - "/images/projects/shadow-manager/cover.png"
  - "/images/projects/shadow-manager/account.png"
  - "/images/projects/shadow-manager/map.png"
  - "/images/projects/shadow-manager/report.png"
  - "/images/projects/shadow-manager/shift-management.png"
team:
  - name: "Lujie Ma"
...
- 📝 [Changelog](./CHANGELOG.md): Our changelog.
- 📕 [Coding Convention](./docs/Conventions.md): Our coding convention.
- 📱 [Native App Documentation](./Frontend/my-app/README.md): Details about our React Native app.
- 🌐 [Web Portal Documentation](./Frontend/Web/README.md): Information on the web portal frontend.
- 💻 [Backend Documentation](./backend/README.md): Technical details about the backend system.
...
- 📝 [Pull Request Checklist](./docs/PullRequestChecklist.md): Checklist for pull requests.
